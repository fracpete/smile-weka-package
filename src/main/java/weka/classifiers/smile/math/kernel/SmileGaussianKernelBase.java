...
/**
 * Superclass for SmileGaussianKernel containing the option handling.
 *
 * @author FracPete
 */
public abstract class SmileGaussianKernelBase
  extends AbstractSmileKernel<smile.math.kernel.GaussianKernel> {
