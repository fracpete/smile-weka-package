...
import weka.classifiers.smile.AbstractSmileClassifier;
...
public abstract class SmileRandomForestBase
  ...
  /** the flag for {@link #m_SplitRule}. */
  public final static String SPLITRULE = "split-rule";
  ...
  public Enumeration listOptions() {
    ...
    WekaOptionUtils.addOption(result, splitRuleTipText(), "" + getDefaultSplitRule(), SPLITRULE);
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    setSplitRule((SplitRule) WekaOptionUtils.parse(options, SPLITRULE, getDefaultSplitRule()));
  ...
  public String[] getOptions() {
    ...
    WekaOptionUtils.add(result, SPLITRULE, getSplitRule());
  ...
  /**
   * The default value for splitRule.
   *
   * @return the default value
   * @see #m_SplitRule
   */
  protected SplitRule getDefaultSplitRule() {
    return smile.classification.DecisionTree.SplitRule.GINI;
  }
  ...
  /**
   * Returns the help string for splitRule.
   *
   * @return the help string
   * @see #m_SplitRule
   */
