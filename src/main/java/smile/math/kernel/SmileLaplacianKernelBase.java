...
/**
 * Superclass for SmileLaplacianKernel containing the option handling.
 *
 * @author FracPete
 */
public abstract class SmileLaplacianKernelBase
  extends AbstractSmileKernel<smile.math.kernel.LaplacianKernel> {
